...
```bash
less /anvil/projects/x-bio240351/shared_data/fastq/SRR957824_500K_R1.fastq.gz
```
...
```
grep -c "^@SR" /anvil/projects/x-bio240351/shared_data/fastq/SRR957824_500K_R1.fastq.gz
```
...
```
awk '(NR%4==2) {print length($0)}' /anvil/projects/x-bio240351/shared_data/fastq/SRR957824_500K_R1.fastq.gz | sort | uniq -c
```
